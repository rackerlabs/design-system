...
- Text inputs should convey the the data type format of the input value entered by the user.
...
Text inputs can be in an *enabled*, *disabled*, and *error* state.
...
- Text area states follow the same layout and behaviors as text inputs.
