## Modified from https://github.com/paulrobertlloyd/jekyll-figure/blob/master/lib/jekyll/figure.rb
  ...
  module Figure
    ...
    class FigureTag < Liquid::Block
      ...
      def render(context)
        ...
        figure_tag += "#{figure_main}</figure>"
        figure_tag += "<figcaption>#{figure_caption}"
        figure_tag += "</figcaption>"
      end
    end
